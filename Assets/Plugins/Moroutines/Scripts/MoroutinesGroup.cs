...
namespace Redcode.Moroutines
{
    ...
    public class MoroutinesGroup
    {
        ...
        /// </summary>
        public List<Moroutine> Moroutines { get; } = new List<Moroutine>();
        ...
        public WaitForAll WaitForComplete() => new WaitForAll(Moroutines.Select(m => m.WaitForComplete()).ToList());
        ...
        public WaitForAll WaitForStop() => new WaitForAll(Moroutines.Select(m => m.WaitForStop()).ToList());
        ...
        /// </summary>
        /// <returns><inheritdoc cref="WaitForComplete"/></returns>
        public WaitForAll WaitForRun() => new WaitForAll(Moroutines.Select(m => m.WaitForRun()).ToList());
        ...
        /// </summary>
        /// <returns><inheritdoc cref="WaitForComplete"/></returns>
        public WaitForAll WaitForReset() => new WaitForAll(Moroutines.Select(m => m.WaitForReset()).ToList());
        ...
        /// </summary>
        /// <returns><inheritdoc cref="WaitForComplete"/></returns>
        public WaitForAll WaitForDestroy() => new WaitForAll(Moroutines.Select(m => m.WaitForDestroy()).ToList());
        #endregion
